...
----	
helm repo add stakater https://stakater.github.io/stakater-chart
helm repo update
...
- Update the https://raw.githubusercontent.com/StinkyBenji/quinoa-wind-turbine-manifests/main/0-quay-secret-tmpl.yaml[0-quay-secret-tmpl] to create a secret named `quay-push-secret` 
